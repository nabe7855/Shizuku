...
import { SparklesIcon, ChatBubbleLeftRightIcon, TrashIcon } from './Icons';
...
const JournalDetailModal: React.FC<JournalDetailModalProps> = ({ entry, onClose, onDelete }) => {
  useEffect(() => {
          ...
          <div style={{ display: 'flex', gap: '0.5rem' }}>
            {onDelete && entry && (
              <button
                ...
                title="削除"
              >
                <TrashIcon className="icon-close" />
              </button>
            )}
